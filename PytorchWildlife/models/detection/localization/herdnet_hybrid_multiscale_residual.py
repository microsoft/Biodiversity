...
from .model_hybrid_multiscale_residual import HerdNet_Hybrid_Multiscale_Residual as HerdNetArchHybridMultiscaleResidual
...
class HerdnetHybridMultiscaleResidual(BaseDetector):
    """
    HerdNet Location Branch detector class. This class provides utility methods for
    ...
    def __init__(self, weights=None, device="cpu", url="https://zenodo.org/records/18177050/files/HerdNet_Hybrid_Multiscale_Residual_wildme.pth?download=1", transform=None):
        ...
        """
        super(HerdnetHybridMultiscaleResidual, self).__init__(weights=weights, device=device, url=url)
    ...
    def _load_model(self, weights=None, device="cpu", url=None):
        ...
        self.model = HerdNetArchHybridMultiscaleResidual(pretrained_cnn=False)
